...
function Home() {
    ...
    const mainBlock = {
        img: {
            src: '/images/content/main-block/new/bg.webp',
            alt: 'bg',
            width: 1448,
            height: 1086,
            srcsets: [
                {
                    srcset: '/images/content/main-block/new/bg.webp',
                    type: 'image/webp',
        ...
        parallax1: {
            src: '/images/content/main-block/new/1.webp',
            alt: 'parallax-1',
            width: 256,
            height: 384,
        },
        parallax2: {
            src: '/images/content/main-block/new/2.webp',
            alt: 'parallax-2',
            width: 256,
            height: 384,
        },
    ...
    const intro = {
        ...
        title: 'Привет! Меня зовут Анастасия Туласова ',
        description: `<p>
           alissa.volya — мой ник во многих социальных сетях и творческий псевдоним. Его мне придумал ChatGPT, пока я скучала в дороге из аэропорта. А теперь по нему меня узнают в интернете многие творческие люди и читатели.
        </p>
        <p>
            Я разработала этот сайт, чтобы показать, что умею в веб-разработке. А еще — чтобы рассказать о своих крутых увлечениях!
        </p>`,
    }
    // const introList = {
